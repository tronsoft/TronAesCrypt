...
internal interface IAesEncryptor
{
    ...
    /// <summary>
    /// Encrypt the stream asynchronously using AES Crypt v3 format with PBKDF2-HMAC-SHA512 key derivation.
    /// </summary>
    /// <param name="inStream">The input stream.</param>
    /// <param name="outStream">The aes crypt output stream</param>
    /// <param name="password">The password to use for encrypting.</param>
    ...
    System.Threading.Tasks.Task EncryptStreamAsync(Stream inStream, Stream outStream, string password, int bufferSize, int kdfIterations = 300_000, System.Threading.CancellationToken cancellationToken = default);
}